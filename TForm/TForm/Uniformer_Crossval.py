...
def train_model(dataloader_train, dataloader_val, fold, input, log_path, num_epochs = 50, learning_rate = 0.00001, weight_decay = 1e-5):
...
if __name__ == "__main__": 
    features_path = 'preprocessed_dataset/nparray_balanced_102x76'
    test_path = 'preprocessed_dataset/nparray_uv_102x76'
    ...
    saved_model_path = 'graphs/3DKFold/Models/best_model_102x76.pth'
