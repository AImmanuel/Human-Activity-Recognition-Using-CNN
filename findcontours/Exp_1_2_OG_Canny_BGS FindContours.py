...
class OpticalFlowComputer:
    ...
    def compute_edge_detector(self, current_frame):
        ...
        contour_img = np.zeros_like(current_frame)
        ...
        # Resize the contour image
        resized_frame = cv2.resize(contour_img, (51, 38))
        ...
        #current_frame_masked = cv2.bitwise_and(edge_frame_curr, edge_frame_curr, mask=fgmask_curr)

        current_frame_masked = cv2.bitwise_and(
            binary_edge_image, binary_edge_image, mask=fgmask_curr
        )
...
if __name__ == "__main__":                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
    try:
        ...
        dataset_folder = "D:/MSc Project/Repo/MscProjectHAR-main/mini_dataset"
