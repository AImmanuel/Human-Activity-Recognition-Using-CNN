...
if __name__ == "__main__":   
    ...
    csv_file_path = "D:/MscProject/Repo/Features_1&0.5_Vision.csv"
    labels_df = pd.read_csv(csv_file_path, skiprows=1)

    #base_folder = '../Outputs/Exp_1_1_OG_BGS_Canny/Unbalanced'
    base_folder = "D:/MscProject/Repo/Outputs/Exp_1_1_OG_BGS_findcontours/Unbalanced"
    print(f"============================================================ ")
    ...
    with open("D:/MscProject/Repo/Outputs/Exp_1_1_OG_BGS_findcontours/loader_log.log", 'a') as file:
