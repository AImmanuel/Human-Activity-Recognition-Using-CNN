...
class OpticalFlowComputer:
    def __init__(self, pyr_scale = 0.5, levels = 3, winsize = 15, iterations = 3, poly_n = 5, poly_sigma = 1.2, flags = 0, resize_dim = (320, 240)):
...
if __name__ ==  "__main__":
    ...
    output_folder  = 'D:/nparray_uv_test_320x240'
