...
class SpeicalPatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=(51,38), patch_size=4, in_chans=2, embed_dim=768):
        super().__init__()
...
class PatchEmbed(nn.Module):
    """ Image to Patch Embedding
    """
    def __init__(self, img_size=(51,38), patch_size=4, in_chans=2, embed_dim=768, std=False):
        super().__init__()
...
if __name__ == "__main__": 
    ...
    saved_model_path = 'graphs/3DKFold/Models/best_model_UniformerNH16.pth'
