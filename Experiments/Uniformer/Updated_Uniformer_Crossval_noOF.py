...
class SpeicalPatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=(51,38), patch_size=16, in_chans=1, embed_dim=768):
        super().__init__()
...
class PatchEmbed(nn.Module):
    """ Image to Patch Embedding
    """
    def __init__(self, img_size=(51,38), patch_size=16, in_chans=1, embed_dim=768, std=False):
        super().__init__()
...
class Uniformer(nn.Module):
    ...
    """
    def __init__(self, depth=[5, 8, 20, 7], num_classes=2, img_size=(51,38), in_chans=1, embed_dim=[64, 128, 320, 512],
